...
Wraps the Ultralytics YOLO API to provide YOLOv12-specific
...
class YOLOv12Detector(BaseDetector):
    """YOLOv12 detector wrapping the Ultralytics YOLO implementation.

    Supports all YOLOv12 model sizes: nano (n), small (s), medium (m),
    ...
    def __init__(self, config: Dict[str, Any]):
        """Initialize YOLOv12 detector with configuration.
        ...
        self.model_name = f"yolov12-{self.variant}"
        self.logger = get_logger("ire.yolov12")

    def load_model(self, weights: Optional[str] = None) -> None:
        """Load YOLOv12 model with pretrained or custom weights.
        ...
        """
        if weights:
            self.logger.info("Loading YOLOv12 from weights: %s", weights)
            ...
            self.logger.info(
                "Loading YOLOv12 pretrained: %s", model_file
            )
    ...
    def train(
        ...
        **kwargs: Any,
        ...
        """Train YOLOv12 on the specified dataset.
        ...
        self.logger.info(
            "Starting YOLOv12 training: epochs=%d, batch=%d, imgsz=%d",
            epochs,
            batch_size,
            image_size,
        )
    ...
    def predict(
        ...
        **kwargs: Any,
        ...
        """Run YOLOv12 inference on images.
    ...
    def evaluate(
        ...
        **kwargs: Any,
        ...
        """Evaluate YOLOv12 on a validation or test dataset.
        ...
        self.logger.info("Evaluating YOLOv12 on %s", data_yaml)
    ...
    def export(self, format: str = "onnx", **kwargs: Any) -> str:
        """Export YOLOv12 model to the specified format.
        ...
        self.logger.info("Exporting YOLOv12 to %s format", format)
